...
export default function Second() {
    ...
    return (
        <div id="second" className="d-flex flex-column align-items-center justify-content-center p-5">
...
Href Href!`)
    ...
    visibility: hidden;
                    ...
                    <ScrollAnimation animateIn="flipInY"
                        ...
                        <div className="cube" onClick={() => {
                            setmodalStyle({ width: "100vw" });
                            setModalText(`When SASS came out, JavaScript developers were very sad :(`)
                        }}>
...
PHP7 - C++`)
                    ...
                    <ScrollAnimation animateIn="flipInY"
                        ...
                        <div className="cube" onClick={() => {
                            setmodalStyle({ width: "100vw" });
                            setModalText(`Nothing worse than ASP.NET can ever happen to a human being... Oh wait`)
                        }}>
                    ...
                    <ScrollAnimation animateIn="flipInY"
                        ...
                        <div className="cube" onClick={() => {
                            setmodalStyle({ width: "100vw" });
                            setModalText(`Yeah playing lego is cool, but just show me - where to write HTML CSS`)
                        }}>
